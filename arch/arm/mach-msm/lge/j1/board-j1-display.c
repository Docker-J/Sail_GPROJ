...
static char backlight_map[] = {
	50, 50, 51, 55, 59, 62, 65, 68, 72, 75, 76,
	78, 80, 81, 82, 84, 85, 86, 87, 88, 89, 90,
	91, 91, 92, 93, 94, 94, 95, 96, 97, 97, 98,
	98, 99, 99, 100, 100, 101, 102, 102, 102, 103, 103,
	104, 104, 104, 105, 106, 106, 107, 107, 108, 108, 108,
	108, 108, 109, 109, 109, 110, 110, 110, 111, 111, 112,
	112, 112, 112, 112, 113, 113, 113, 114, 114, 114, 115,
...
#if defined(CONFIG_LGE_BACKLIGHT_CABC)
	.max_current = 0x15 | PWM_BRIGHTNESS,	//20121107 ej.jung ABS : Exp. -> Linear (0x15 -> 0x17)
#else
	.max_current = 0x15,					//20121107 ej.jung ABS : Exp. -> Linear (0x15 -> 0x17)
#endif
	.default_brightness = 0x10,	
	.min_brightness = 0x01,
	.max_brightness = 0x72,
	.blmap = backlight_map,
